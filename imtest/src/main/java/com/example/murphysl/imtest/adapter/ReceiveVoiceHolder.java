...
import com.example.murphysl.imtest.IM.NewRecordPlayClickListener;
...
public class ReceiveVoiceHolder extends BaseViewHolder {
    ...
    public void bindData(Object o) {
        ...
        ImageLoaderFactory.getLoader().loadAvator(iv_avatar,info != null ? info.getAvatar() : null, R.mipmap.niyou);
