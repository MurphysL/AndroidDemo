...
import com.example.murphysl.imtest.base.MyMutlipleItem;
import com.example.murphysl.imtest.bean.NewFriendConversation;
...
import com.example.murphysl.imtest.bean.PrivateConversation;
import com.example.murphysl.imtest.R;
import com.example.murphysl.imtest.adapter.ConversationAdapter;
import com.example.murphysl.imtest.bean.Conversation;
import com.example.murphysl.imtest.db.NewFriend;
import com.example.murphysl.imtest.db.NewFriendManager;
import com.example.murphysl.imtest.event.RefreshEvent;
 ...
 *
 * @author: MurphySL
 * @time: 2016/10/10 12:32
 */

public class CoversationFragment extends ParentWithNaviFragment {
