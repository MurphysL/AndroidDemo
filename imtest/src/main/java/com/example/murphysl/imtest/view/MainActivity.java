...
import com.example.murphysl.imtest.base.BackHandledInterface;
import com.example.murphysl.imtest.base.ParentWithNaviFragment;
import com.example.murphysl.imtest.R;
import com.example.murphysl.imtest.base.BaseActivity;
...
import com.example.murphysl.imtest.util.IMMLeaks;
...
public class MainActivity extends BaseActivity implements View.OnClickListener, ViewPager.OnPageChangeListener,
        BackHandledInterface, ObseverListener {
  ...
  /*@Bind(R.id.id_indicator_two)
    ...
    private void initListener() {
        ...
        id_viewpager.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    protected void initView() {
        super.initView();
        CoversationFragment f1 = new CoversationFragment();
    ...
    @OnClick({R.id.id_indicator_one, R.id.id_indicator_three , R.id.id_indicator_four})
